        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TemplateConfigurationId = table.Column<int>(type: "INTEGER", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_EngagementModels_ProjectAccounts_ProjectAccountId",
                        column: x => x.ProjectAccountId,
                        principalTable: "ProjectAccounts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Functions_ProjectAccounts_ProjectAccountId",
                        column: x => x.ProjectAccountId,
                        principalTable: "ProjectAccounts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Products_ProjectAccounts_ProjectAccountId",
                        column: x => x.ProjectAccountId,
                        principalTable: "ProjectAccounts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Segments_ProjectAccounts_ProjectAccountId",
                        column: x => x.ProjectAccountId,
                        principalTable: "ProjectAccounts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Divisions_Segments_SegmentId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EngagementModels_ProjectAccountId",
                table: "EngagementModels",
                column: "ProjectAccountId");

            migrationBuilder.CreateIndex(
                name: "IX_Functions_ProjectAccountId",
                table: "Functions",
                column: "ProjectAccountId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Products_ProjectAccountId",
                table: "Products",
                column: "ProjectAccountId");

            migrationBuilder.CreateIndex(
                name: "IX_Segments_ProjectAccountId",
                table: "Segments",
                column: "ProjectAccountId");
        }
